    ...
    return AnimatedScale(
      ...
      child: GestureDetector(
        ...
        child: Container(
          height: 120,
          decoration: BoxDecoration(
            color: Colors.white.withValues(alpha: active ? 0.05 : 0.02),
            borderRadius: BorderRadius.circular(24),
            border: Border.all(color: widget.accent.withValues(alpha: active ? 0.2 : 0.05)),
          ),
          ...
          child: Column(
            ...
            children: [
              Container(
                 ...
                 child: Icon(widget.icon, color: active ? widget.accent : Colors.white38, size: 28),
              ),
...
class _WideActionCard extends StatefulWidget {
  const _WideActionCard({
    required this.title, required this.subtitle, required this.icon, required this.accent, required this.onTap
  });
  final String title;
             ...
             children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                       Text(widget.title, style: GoogleFonts.manrope(fontSize: 16, fontWeight: FontWeight.w800, color: Colors.white)),
                       const SizedBox(height: 4),
                       Text(widget.subtitle, style: GoogleFonts.inter(fontSize: 13, color: Colors.white60)),
                    ]
                  )
                ),
